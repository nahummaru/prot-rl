...
This 3 different loss functions were adapted from the firsts described in [Widatalla et al., 2024](https://www.biorxiv.org/content/10.1101/2024.05.20.595026v1.abstract). You can find detailed explanations for each loss function and its changes in formulation in the Methods section of the [paper](). We reccomend in appling the weighted form as it has been estensively tested during our experiments and in most of the casese has higher performance. We are currently working to provide refined also for the ranked and paired form.
